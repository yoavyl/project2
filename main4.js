...
$(function () {
    ...
    function topFive(top) {
        ...
        if (top.checked === false) {
            ...
            if (tempCoinString !== null) {
                ...
                $(`#containerDiv input[id=${coinToAdd.symbol}]`).prop('checked', true).attr('checked', 'checked');
    ...
    function showMore(more) {
        // console.log("more.name: " + more.name) //undefined. problem of modal/more is here
        console.log(more); //because he gets the name from top5, and it has to be id
